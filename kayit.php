...
<h2>
<span class="main-text">Hemen Sende</span>
<span class="background-rectangle-skew">Kayıt Ol</span>
</h2>
<div class="container">
...
<center><h5>
                        <?php
                        if ($_GET["durum"]=="var") {
                          echo "Böyle bir kullanıcı adı ve ya e-posta kayıtlı.";
                        }elseif ($_GET["durum"]=="olmadi") {
                          echo "Kayır işlemi başarısız.";
                        }elseif ($_GET["sifre"]=="olmadi") {
                          echo "Şifreler eşleşmedi, lütfen şifrelerinizi doğru giriniz.";
                        }elseif ($_GET["dogrulama"]=="yanlis") {
                          echo "Güvenlik doğrulaması yapılmadı." ;
                        }elseif ($_GET["bos"]=="var") {
...
<button name="register" type="submit">Kayıt Ol</button>
</form>
<div class="auth-footer">
<div class="auth-footer-head">Kullanıcı sözleşmesini okudum ve </div>
<a href="main\agreement.pdf" class="auth-footer-bot">kabul ediyorum</a>
</div>
</div>
</div>
</div>
...
<script type="text/javascript">
	$(".registration").submit(function(){
		...
		var sendData = { login: login , email: email, password: password, recaptcha: recaptcha};
		$.ajax ({
			type: 'POST',
